// core/services/cloudinary_services.dart
...
class CloudinaryService {
  ...
  Future<UploaderResponse<UploadResult>> uploadImage({
    ...
    try {
      ...
      final response = await _uploader.upload(file, params: params);
  ...
  // Quick access methods for different folders
  Future<UploaderResponse<UploadResult>> uploadAvatar(
    File file,
    String userId,
  ) {
    return uploadImage(
  ...
  Future<UploaderResponse<UploadResult>> uploadCoverPhoto(
    File file,
    String userId,
  ) {
    return uploadImage(
