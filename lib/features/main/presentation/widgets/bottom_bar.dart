  ...
  Widget build(BuildContext context) {
    ...
    final glassSettings =
        ...
        LiquidGlassSettings(
          ...
          thickness: 30,
          blur: 0, // Disable internal blur, we manage it manually
          saturation: 1.5,
          lightIntensity: isDark ? .3 : 0.8,
          ambientStrength: isDark ? .1 : 0.5,
          lightAngle: math.pi / 4,
          glassColor:
              (isDark
                      ? const Color(0xFF000000)
                      : CupertinoTheme.of(context).barBackgroundColor)
                  .withValues(alpha: isDark ? 0.6 : 0.2), // More transparent
        );
          ...
          child: Row(
            ...
            children: [
              Expanded(
                child: Stack(
                  children: [
                    // Layer 1: Visuals (Shadow, Blur, Glass) - Moved out of _TabIndicator
                    Positioned.fill(
                      child: Container(
                            ...
                            ClipPath(
                              ...
                              child: BackdropFilter(
                                filter: ImageFilter.blur(
                                  sigmaX:
                                      50, // Increased blur for "dreamy" look
                                  sigmaY: 50,
                                ),
                                child: Container(
                                  color: isDark
